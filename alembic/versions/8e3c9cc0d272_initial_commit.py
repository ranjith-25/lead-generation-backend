...
Revision ID: 8e3c9cc0d272
Revises: 
Create Date: 2026-08-04 13:17:50.000444
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'rolePermissions', 'permissions', ['permission_id'], ['permission_id'])
    op.create_foreign_key(None, 'rolePermissions', 'roles', ['role_id'], ['role_id'])
